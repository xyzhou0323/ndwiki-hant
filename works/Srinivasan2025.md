...
Srinivasan 提出**"神經多樣性 2.0"（Neurodiversity 2.0）**框架——通過整合殘障研究、社會正義與政策的跨學科洞見，對神經多樣性運動的基礎原則進行系統升級。核心操作是**拒絕當前話語中主導的三組虛假二元**：

| 虛假二元 | ND 2.0 的整合路徑 |
|----------|------------------|
| 社會模型 vs 醫學模型 | 承認共現醫學問題（癲癇、胃腸問題）的真實性，同時拒絕"修復"神經類型的生物醫學敘事 |
| 自主 vs 依賴 | 以關懷倫理學和關係性自主替代獨立性的黃金標準——所有人都在關係中實現自主 |
| 優勢 vs 缺陷 | 同時承認優勢與挑戰，拒絕非此即彼——診斷遮蔽（diagnostic overshadowing）對二者都造成傷害 |

## 框架整合的理論資源

Srinivasan 將神經多樣性運動與多學科理論資源對接，將框架建立在遠比運動傳統話語更廣泛的理論基礎上：

| 領域 | 整合的理論 |
|------|-----------|
| 自主與支持 | 關懷倫理學（Care Ethics）、關係性自主（Relational Autonomy） |
...
- **獨立性作爲黃金標準**：神經多樣性話語過度強調獨立性——這排斥了實質上需要支持的羣體
- **庸俗版神經多樣性**：企業僅收編可市場化特質（模式識別、超專注），系統性排斥無"市場價值"的神經類型
- **孤獨譜系中心主義**：孤獨譜系主導話語，ADHD、智力障礙、心理社會殘障等其他神經類型代表性不足
- **交叉性缺失**：共現殘障和交叉身份在主流敘事中被邊緣化

### 2. 醫學模型的複雜性

- **診斷遮蔽**（diagnostic overshadowing）：共現醫學問題（癲癇、胃腸問題、慢性疼痛）被歸因爲"都是孤獨譜系的一部分"而被忽視
- 在抵制生物醫學"修復"敘事的正當鬥爭中，運動有時走向了否認共現醫學問題真實性的反面
- 這不是迴歸醫學模型——而是要求在**不將神經類型病理化**的前提下，認真對待健康問題

### 3. 研究與政策的排斥

- **"可研究孤獨譜系者"的區域**（zone of researchable autistic）：研究偏向語言流利、可接受認知測試的個體——排除最少口語、智力障礙、多重殘障的羣體
- **參與式研究的實質性問題**：形式上的社羣參與（諮詢委員會）往往缺乏真正的決策權
- 政策設計基於對"孤獨譜系者"的狹窄想象——無法反映社羣內部的實際多樣性
...
- **[[殘障模型]]** 中的生物心理社會模型和 ICF 被 ND 2.0 整合爲醫學-社會橋樑
