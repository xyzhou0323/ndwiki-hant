...
aliases: ["Sarr(2025)", Sarr 2024, Sarr et al. 2024, 鑑別診斷Delphi]
...
Delphi 共識識別的核心區分在於**成因、初始發生時間、以及特異性特徵的底層機制**：

#### 青少年：孤獨譜系 vs CPTSD

| 維度     | 孤獨譜系                     | CPTSD                                   | 共識        |
| ------ | ------------------------ | --------------------------------------- | --------- |
| 發生     | 出生或幼兒期即顯現（6-12 月可有跡象）    | 創傷事件後出現                                 | 96%       |
| 進展     | 終生性                      | 並非必然終生（取決於創傷對發育腦的影響、發育時機、創傷性質和對循證干預的應答） | 96%       |
...
| 維度     | 孤獨譜系               | 依戀障礙                     | 共識  |
| ------ | ------------------ | ------------------------ | --- |
| 成因     | 神經發育性              | 5 歲前照護不足（忽視、多次更換照護者、機構化） | 80% |
...
1. **全面歷史採集**（與個體、家長/照護者）——必須包括發育史和家族史（共識 94%–96%）
2. **特徵初始發生相對於創傷事件的時間線**（CPTSD 鑑別必需）
3. **參考診斷標準**（DSM/ICD）
4. **狀況特異性量表**：
...
- 信息不完整（知情人不可靠、發育史缺失、特徵初始發生不清晰、語言障礙）
