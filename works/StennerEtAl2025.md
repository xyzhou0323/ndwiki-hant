...
討論中 Steven Kapp 指出，F1 的立場可能被"重度孤獨譜系"（profound autism）支持者用來論證"神經多樣性不適用於他們"。Amy Pearson 回應：這種可能性不應阻止我們承認 F1 觀點的存在及其理由。Lill Hultman 補充了重要細微差別：她在 ND2 F1 中表達的立場是**戴上"學術帽子"**時的立場——如果換上"**行動者帽子**"，她可能會以接近 F2 的模式排序。**Q 方法不預設所表達觀點與表達者之間有任何一一對應的綁定關係——人可以在視角之間移動。**
