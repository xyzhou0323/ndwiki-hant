---
title: RAADS-R
description: Ritvo 孤獨譜系量表修訂版（RAADS-R, Ritvo Autism Asperger Diagnostic Scale–Revised）是一份80題自填工具，由 Ritvo et al. (2011) 開發，區分16歲前與當前的孤獨譜系特徵，採用 NovoPsych (2025) 更新的臨牀閾值
...
RAADS-R 總分範圍 0-240。原始界值 65 分因在臨牀人羣中假陽性率過高而受到批評——研究報道特異度低至 3%（Jones et al., 2021），超過半數的精神健康門診就診者得分高於該界值（Folatti et al., 2024）。NovoPsych (2025) 基於 37,620 例同時完成 RAADS-R 和 AQ 的臨牀樣本，以 AQ ≥ 26 和 AQ ≥ 36 爲校標進行 ROC 分析，確定了以下更新界值：
...
基於 Andersen et al. (2011) 的瑞典臨牀樣本（N = 197），包括醫生、醫學生、大學生、研究對照參與者和少數精神科就診者（含抑鬱、社交焦慮、廣泛性焦慮、ADHD、雙相等診斷）。該樣本比 Ritvo et al. (2011) 的原始常模樣本更具臨牀代表性。均值 33.8（SD = 27.6）。
...
- **促進討論**：可促進關於受測者可能不會自發報告的經歷的討論，如感覺敏感性或掩飾與僞裝策略
