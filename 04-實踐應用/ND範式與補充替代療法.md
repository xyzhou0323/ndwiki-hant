...
aliases: [CAM, ND範式與CAM, ND範式的治療篩選作用, 補充替代療法, Complementary and Alternative Medicine, ASD補充替代療法, ASD CAM, 替代療法]
...
- **不允許**：以“正常化”或“治癒”爲目標的干預（如壓制自我調節行爲、壓制強烈興趣）
...
[[NICE2021|NICE (2021)]] 是ND範式原則在主流臨牀政策中的部分滲透案例。雖然其底層框架仍根植於[[常態範式]]（將孤獨譜系定義爲需要“診斷與管理”的“病症”），但指南中的若干元素與ND取向兼容：
